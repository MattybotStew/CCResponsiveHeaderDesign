...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "CC Responsive Header Design"
...
/**
 * Serves a blank render-target page for component previews. The page
 * exposes a registry of every file matching `storiesGlob` so the
 * preview surface can dynamically import and mount each entry.
 *
